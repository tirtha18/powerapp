...
const Contacts = () => {
  ...
  return (
    <div className="h-full w-full bg-gradient-to-b from-black to-gray-900 text-white overflow-auto">
      <div className="flex px-10 py-28 h-full w-full"></div>
